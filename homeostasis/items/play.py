...
def register_play_items():
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=5, social=10, energy=-15),
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=4, social=-10, energy=-5, fun=10),
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=4, social=-5, energy=-10),
        tags=frozenset({"playable", "quiet"}),
    ))
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=3, energy=-5),
        tags=frozenset({"playable", "quiet"}),
    ))
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=6, social=15, energy=-20),
        tags=frozenset({"playable"}),
    ))
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=3, social=-15, energy=-5),
        tags=frozenset({"playable", "quiet"}),
    ))
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=2, energy=15, social=-5),
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=4, energy=-25),
        tags=frozenset({"playable"}),
    ))
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=2, energy=5, social=-15),
        tags=frozenset({"playable", "quiet"}),
    ))
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=5, energy=-20, social=-5),
        tags=frozenset({"playable"}),
    ))
    ...
    register_item(ItemDefinition(
        ...
        effects=Motives(happiness=3, energy=-5, fun=10),
        tags=frozenset({"playable"}),
    ))