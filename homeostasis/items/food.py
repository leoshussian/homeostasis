...
def register_food_items():
    ...
    register_item(ItemDefinition(
        ...
        max_durability=1,
        personality=PersonalityMatrix(9, 9, 2, 10),
    ...
    register_item(ItemDefinition(
        ...
        max_durability=1,
        personality=PersonalityMatrix(3, 8, 5, 7),
    ...
    register_item(ItemDefinition(
        ...
        max_durability=1,
        personality=PersonalityMatrix(7, 6, 8, 5),
    ...
    register_item(ItemDefinition(
        ...
        max_durability=1,
        personality=PersonalityMatrix(8, 2, 4, 9),
    ...
    register_item(ItemDefinition(
        ...
        max_durability=1,
        personality=PersonalityMatrix(2, 5, 7, 6),
    ...
    register_item(ItemDefinition(
        ...
        max_durability=1,
        personality=PersonalityMatrix(9, 9, 3, 8),
    ...
    register_item(ItemDefinition(
        ...
        max_durability=1,
        personality=PersonalityMatrix(6, 4, 5, 9),
